...
import { GoogleModelConfigService } from '../services/googleModelConfigService';
import { authenticateToken } from '../middleware/auth';
import { initGoogleModelConfigsTable } from '../scripts/initGoogleModelConfigs';

const router = Router();
const googleModelConfigService = GoogleModelConfigService.getInstance();
...
router.get('/', async (req: Request, res: Response, next) => {
    try {
        ...
        const result = await googleModelConfigService.getAllModelConfigs();
