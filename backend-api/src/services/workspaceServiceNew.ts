 ...
 */
export class WorkspaceServiceNew {
    private static instance: WorkspaceServiceNew;
    ...
    public static getInstance(): WorkspaceServiceNew {
        if (!WorkspaceServiceNew.instance) {
            WorkspaceServiceNew.instance = new WorkspaceServiceNew();
        }
        return WorkspaceServiceNew.instance;
    }
