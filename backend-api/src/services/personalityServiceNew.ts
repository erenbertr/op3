 ...
 */
export class PersonalityServiceNew {
    private static instance: PersonalityServiceNew;
    ...
    public static getInstance(): PersonalityServiceNew {
        if (!PersonalityServiceNew.instance) {
            PersonalityServiceNew.instance = new PersonalityServiceNew();
        }
        return PersonalityServiceNew.instance;
    }
